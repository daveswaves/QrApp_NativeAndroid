...
### Required files
* app/src/main/java/com/daveswaves/qrapp/MainActivity.kt  
...
class MainActivity : AppCompatActivity() {
    ...
    private fun connectToWifi(ssid: String, password: String, encryption: String?) {
